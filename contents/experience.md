...
**2026年4月 - 2026年8月** 
#### Key Contributions:
- 基于 ESP32-S3 与 FreeRTOS 开发单涵道矢量飞行器飞控系统，完成六自由度动力学建模与状态空间建模，在 MuJoCo 中进行 LQR 控制器仿真与参数调优，并部署至实物平台；完成陀螺仪/光流传感器融合、矢量喷口控制及飞控任务调度，基本实现系留条件下姿态和位置的稳定保持。

Mujoco仿真视频链接  
https://github.com/user-attachments/assets/126e4757-54fe-47db-9e12-a3899b1628ed
...
<div style="display:flex; gap:12px; align-items:center;">
  <img src="static/assets/img/涵道.jpg" style="height:300px; object-fit:cover;" alt="图1">
  <img src="static/assets/img/倾角补偿.png" style="height:300px; object-fit:cover;" alt="图2">
  <img src="static/assets/img/喷管.jpg" style="height:300px; object-fit:cover;" alt="图3">
</div>
